...
/**
 * @minions-qa-rules/cli — CLI for Minions Qa-rules
 *
...
import { customTypes } from '@minions-qa-rules/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Qa-rules'));
        console.log(chalk.dim('Validation rules, consistency checks, compliance gates, and auto-fix definitions'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-qa-rules/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-qa-rules/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-qa-rules')}`);
