# Contributing to Minions Qa-rules

Thank you for your interest in contributing to Minions Qa-rules!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-qa-rules.git`
